...
import 'package:fyp_project/Client/order/order_form_scree.dart';
import 'package:fyp_project/Client/order/progress_bar.dart';
import 'package:fyp_project/Client/order/text_form.dart';
import 'package:fyp_project/Client/proposal/showBider.dart';
...
class ArchivedProposalShowScreen extends StatefulWidget {
  const ArchivedProposalShowScreen({Key? key});

  @override
  State<ArchivedProposalShowScreen> createState() =>
      _ArchivedProposalShowScreenState();
}

class _ArchivedProposalShowScreenState
    extends State<ArchivedProposalShowScreen> {
  Uuid uuid = Uuid();
  ...
  Future<void> fetchData() async {
    try {
      ...
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .where('proposal_status', isEqualTo: "2")
          .get();
      ...
      for (QueryDocumentSnapshot documentSnapshot in querySnapshot.docs) {
        ...
        if (documentData != null) {
          ...
          // Create a VendorStoreData object and add it to the list
                                      ...
                                      ElevatedButton(
                                        onPressed: () async {
                                          ...
                                          if (querySnapshot.docs.isNotEmpty) {
                                            ...
                                            // Assuming 'fieldToUpdate' is the field you want to update, and 'newValue' is the new value
